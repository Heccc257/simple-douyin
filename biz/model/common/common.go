...
type User struct {
	...
	Avatar          string `thrift:"avatar,6" form:"avatar" json:"avatar"`
	BackgroundImage string `thrift:"background_image,7" form:"background_image" json:"background_image"`
	Signature       string `thrift:"signature,8" form:"signature" json:"signature"`
	TotalFavorited  int64  `thrift:"total_favorited,9" form:"total_favorited" json:"total_favorited"`
	WorkCount       int64  `thrift:"work_count,10" form:"work_count" json:"work_count"`
	FavoriteCount   int64  `thrift:"favorite_count,11" form:"favorite_count" json:"favorite_count"`
}
